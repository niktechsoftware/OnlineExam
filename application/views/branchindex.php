...
<body class="fix-menu">
    ...
    <section class="login-block">
        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-sm-12">
                    <form class="md-float-material form-material" method="post" action="<?php echo base_url()?>login/branchIndexReg" enctype="multipart/form-data">
                        <div class="text-center">
                            <img src=" <?php echo base_url();?>assets/images/logo.png" alt="logo.png">
                        </div>
                        <div class="auth-box card" style="max-width: 650px;">
                            <div class="card-block">
                                ...
                                <div class="form-group form-primary">
                                    <input type="text" name="name" class="form-control" required="" placeholder="Enter Your Branch Name">
                                ...
                                <div class="form-group form-primary">
                                    <input type="file" name="photo" class="form-control" required="" placeholder=" Enter Your Photo">
                                    <span class="form-bar"></span>
                                </div>
                                 <div class="form-group form-primary">
                                 ...
                                 <div class="form-group form-primary">
                                    <input type="text" name="city" class="form-control" required="" placeholder=" EnterYour City">
                                    <span class="form-bar"></span>
                                </div>
                                <div class="form-group form-primary">
                                ...
                                <div class="form-group form-primary">
                                    <input type="number" name="pincode" class="form-control" required="" placeholder=" Enter Your Pincode">
                                    <span class="form-bar"></span>
                                </div>
                                 <div class="form-group form-primary">
