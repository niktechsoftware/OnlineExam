                       ...
                       <div class="row">
                          <div class="col-md-4">
                           <div class="row">
                                 ...
                                 <div class="col-md-1"><a href="<?php echo base_url()?>subbranchController/updatesubBranchDetailView/<?php echo $row->row()->id;?>" ><i class="fa fa-edit" style="font-size:20px;color: #c7c2c2;"></i></a></div>
                              </div>
                              <hr>
                             <div class="row">
                          ...
                          <div class="col-md-8">
                              ...
                              <div class="row">
                                 <div class="col-md-3"><label> Sub Branch Name</label></div>
                                 <div class="col-md-8">
                                    <div class="form-group form-primary">
