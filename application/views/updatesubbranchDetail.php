<div class="row">
	<div class="col-md-12">
      <?php  $id= $this->uri->segment(3);
		...
		<form method="post" action="<?php echo base_url()?>subbranchController/updatesubbranchReg/<?php echo $id;?>"  class="form-detail" enctype="multipart/form-data">
                 ...
                 <div class="row">
                    <div class="col-md-12">
                       <div class="row">
                        ...
                        <div class="row">
                                 <div class="col-md-12">
                                    <button class="btn btn-info btn-block">Update Details</button>
                                </div>
                                 </div>
                    </div>
                 </div>      
