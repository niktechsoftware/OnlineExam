<div class="row">
	<div class="col-md-12">
      <?php  //$id= $this->uri->segment(3);
		...
		<form method="post" action="<?php echo base_url()?>adminController/adminUpdateProfile/<?php echo $uname;?>"  class="form-detail" enctype="multipart/form-data">
                          ...
                          <div class="col-md-8">
                              ...
                              <div class="row">
                               ...
                               <div class="row">
                                 ...
                                 <div class="col-md-9">
                                    <div class="form-group form-primary">
                                  <input type="text" name="city" class="form-control" required="" value="<?php echo $row->row()->city;?>" >
                                    <span class="form-bar"></span>
                                </div>
                                 </div>
                               ...
                               <div class="row">
                                 ...
                                 <div class="col-md-9">
                                    <div class="form-group form-primary">
                                 <input type="text" name="state" class="form-control" required="" value="<?php echo $row->row()->state;?>" >
                                    <span class="form-bar"></span>
                                </div>
                                 </div>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-9">
                                    <div class="form-group form-primary">
                                <input type="text" name="country" class="form-control" required="" value="<?php echo $row->row()->country;?>">
                                    <span class="form-bar"></span>
                                </div>
                                 </div>
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-md-9">
                                    <div class="form-group form-primary">
                               <input type="number" name="pincode" class="form-control" required="" value="<?php echo $row->row()->pincode;?>">
                                    <span class="form-bar"></span>
                                </div>
                                 </div>
                       	...
                       	<div class="row">
                                 <div class="col-md-12">
                                    <div class="form-group form-primary">
                                   <button class="btn btn-info btn-block">Update Detail</button>
                                    <span class="form-bar"></span>
                                </div>
                                 </div>
                              </div>
